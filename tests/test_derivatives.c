...
typedef void (*op1d_t)(double *, const double *, const MKL_INT, const double, const MKL_INT,
...
typedef void (*op2d_t)(double *, const double *, const MKL_INT, const double, const MKL_INT,
...
static void measure_2d_r(op2d_t fn, MKL_INT deriv, MKL_INT sym, MKL_INT order, double h, double *ei,
                         double *eg)
{
    const MKL_INT ghost = (order == 2) ? 1 : 2;
...
static void measure_2d_z(op2d_t fn, MKL_INT deriv, MKL_INT sym, MKL_INT order, double h, double *ei,
                         double *eg)
{
    const MKL_INT ghost = (order == 2) ? 1 : 2;
...
static void check_conv_2d(const char *name, op2d_t fn, MKL_INT deriv, MKL_INT sym, MKL_INT order,
                          measure_2d_fn measure)
{
    double ei1, eg1, ei2, eg2, oi, og;
...
static void check_r_stencil(op2d_t fn, MKL_INT order, MKL_INT deriv, MKL_INT ie, const MKL_INT *off,
                            MKL_INT npts)
{
