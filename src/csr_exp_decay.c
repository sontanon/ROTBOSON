...
)
{
    ...
    // RHS.
    double psi = u[k + IDX(i, j)];
    double Dr_psi = D1_4_0 * u[k + IDX(i - 2, j)] + D1_4_1 * u[k + IDX(i - 1, j)] +
                    D1_4_3 * u[k + IDX(i + 1, j)] + D1_4_4 * u[k + IDX(i + 2, j)];
    double Dz_psi = S1_4_0 * u[k + IDX(i, j - 4)] + S1_4_1 * u[k + IDX(i, j - 3)] +
                    S1_4_2 * u[k + IDX(i, j - 2)] + S1_4_3 * u[k + IDX(i, j - 1)] + S1_4_4 * psi;
...
)
{
    ...
    // RHS.
    double psi = u[k + IDX(i, j)];
    double Dr_psi = S1_4_0 * u[k + IDX(i - 4, j)] + S1_4_1 * u[k + IDX(i - 3, j)] +
                    S1_4_2 * u[k + IDX(i - 2, j)] + S1_4_3 * u[k + IDX(i - 1, j)] + S1_4_4 * psi;
    double Dz_psi = D1_4_0 * u[k + IDX(i, j - 2)] + D1_4_1 * u[k + IDX(i, j - 1)] +
                    D1_4_3 * u[k + IDX(i, j + 1)] + D1_4_4 * u[k + IDX(i, j + 2)];
    double f = ri * Dr_psi + zi * Dz_psi + (rr * chi + l + 1.0) * psi;
...
)
{
    ...
    // RHS.
    double psi = u[k + IDX(i, j)];
    double Dr_psi = SO1_4_0 * u[k + IDX(i - 3, j)] + SO1_4_1 * u[k + IDX(i - 2, j)] +
                    SO1_4_2 * u[k + IDX(i - 1, j)] + SO1_4_3 * psi + SO1_4_4 * u[k + IDX(i + 1, j)];
    double Dz_psi = S1_4_0 * u[k + IDX(i, j - 4)] + S1_4_1 * u[k + IDX(i, j - 3)] +
                    S1_4_2 * u[k + IDX(i, j - 2)] + S1_4_3 * u[k + IDX(i, j - 1)] + S1_4_4 * psi;
    double f = ri * Dr_psi + zi * Dz_psi + (rr * chi + l + 1.0) * psi;
...
)
{
    ...
    double Dr_psi = S1_4_0 * u[k + IDX(i - 4, j)] + S1_4_1 * u[k + IDX(i - 3, j)] +
                    S1_4_2 * u[k + IDX(i - 2, j)] + S1_4_3 * u[k + IDX(i - 1, j)] + S1_4_4 * psi;
    double Dz_psi = SO1_4_0 * u[k + IDX(i, j - 3)] + SO1_4_1 * u[k + IDX(i, j - 2)] +
                    SO1_4_2 * u[k + IDX(i, j - 1)] + SO1_4_3 * psi + SO1_4_4 * u[k + IDX(i, j + 1)];
    double f = ri * Dr_psi + zi * Dz_psi + (rr * chi + l + 1.0) * psi;
