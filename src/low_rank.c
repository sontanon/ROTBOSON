...
void solver_diff_gen(rb_context *ctx)
{
	...
	if (ctx->order == 4)
	{
		...
		ndiff = (P4_CC[0] + P4_CC[1] + P4_CC[2] + P4_CC[3] + P4_CC[4] + P4_CC[5]) * ctx->NrInterior * ctx->NzInterior;
		// Add boundary strip.
		// cs: 30 + 30 + 29 + 38 + 31 + 41 = 199.
		// sc: 30 + 30 + 29 + 38 + 31 + 43 = 201.
		// ss: 30 + 30 + 29 + 38 + 31 + 43 = 201.
		ndiff += (P4_CS[0] + P4_CS[1] + P4_CS[2] + P4_CS[3] + P4_CS[4] + P4_CS[5]) * ctx->NrInterior;
		ndiff += (P4_SC[0] + P4_SC[1] + P4_SC[2] + P4_SC[3] + P4_SC[4] + P4_SC[5]) * ctx->NzInterior;
	...
	else
	{
		...
		ndiff = (P2_CC[0] + P2_CC[1] + P2_CC[2] + P2_CC[3] + P2_CC[4] + P2_CC[5]) * ctx->NrInterior * ctx->NzInterior;
		// Add phiBoundOrder.
	...
	if (ctx->order == 4)
	{
		...
		for (i = ctx->ghost; i < ctx->ghost + ctx->NrInterior; ++i)
		{
			...
			// 2. beta: 29 points.
			offset[1] = 1 + 2 * (P4_CC[0] * ctx->NrInterior * ctx->NzInterior 
					+ P4_CS[0] * ctx->NrInterior 
					+ P4_SC[0] * ctx->NzInterior 
					+ P4_SS[0]
			...
			offset[2] = 1 + 2 * ((P4_CC[0] + P4_CC[1]) * ctx->NrInterior * ctx->NzInterior 
					...
					+ (P4_SC[0] + P4_SC[1]) * ctx->NzInterior 
					+ (P4_SS[0] + P4_SS[1])
			...
			// 4. log_a: 38 points.
			offset[3] = 1 + 2 * ((P4_CC[0] + P4_CC[1] + P4_CC[2]) * ctx->NrInterior * ctx->NzInterior 
			...
			// 5. psi: 31 points.
			offset[4] = 1 + 2 * ((P4_CC[0] + P4_CC[1] + P4_CC[2] + P4_CC[3]) * ctx->NrInterior * ctx->NzInterior 
			...
			// 6. lambda: 40 points.
			offset[5] = 1 + 2 * ((P4_CC[0] + P4_CC[1] + P4_CC[2] + P4_CC[3] + P4_CC[4]) * ctx->NrInterior * ctx->NzInterior 
		...
		for (j = ctx->ghost; j < ctx->ghost + ctx->NzInterior; ++j)
		{
			...
			// 3. log_h: 29 points.
			offset[2] = 1 + 2 * ((P4_CC[0] + P4_CC[1] + P4_CC[2]) * ctx->NrInterior * ctx->NzInterior 
				+ (P4_CS[0] + P4_CS[1] + P4_CS[2]) * ctx->NrInterior
				+ (P4_SC[0] + P4_SC[1]) * ctx->NzInterior
				+ (P4_SS[0] + P4_SS[1])
				+ P4_SC[2] * (j - ctx->ghost));
			...
			// 4. log_h: 38 points.
			offset[3] = 1 + 2 * ((P4_CC[0] + P4_CC[1] + P4_CC[2] + P4_CC[3]) * ctx->NrInterior * ctx->NzInterior 
				+ (P4_CS[0] + P4_CS[1] + P4_CS[2] + P4_CS[3]) * ctx->NrInterior
				+ (P4_SC[0] + P4_SC[1] + P4_SC[2]) * ctx->NzInterior
				+ (P4_SS[0] + P4_SS[1] + P4_SS[2])
				+ P4_SC[3] * (j - ctx->ghost));
			...
			// 5. psi: 31 points.
			offset[4] = 1 + 2 * ((P4_CC[0] + P4_CC[1] + P4_CC[2] + P4_CC[3] + P4_CC[4]) * ctx->NrInterior * ctx->NzInterior 
			...
			// 6. lambda: 43 points.
			offset[5] = 1 + 2 * ((P4_CC[0] + P4_CC[1] + P4_CC[2] + P4_CC[3] + P4_CC[4] + P4_CC[5]) * ctx->NrInterior * ctx->NzInterior 
				+ (P4_CS[0] + P4_CS[1] + P4_CS[2] + P4_CS[3] + P4_CS[4] + 2 + P4_CS[5]) * ctx->NrInterior
		...
		offset[5] = 1 + 2 * ((P4_CC[0] + P4_CC[1] + P4_CC[2] + P4_CC[3] + P4_CC[4] + P4_CC[5]) * ctx->NrInterior * ctx->NzInterior 
			+ (P4_CS[0] + P4_CS[1] + P4_CS[2] + P4_CS[3] + P4_CS[4] + 2 + P4_CS[5]) * ctx->NrInterior
			+ (P4_SC[0] + P4_SC[1] + P4_SC[2] + P4_SC[3] + P4_SC[4] + 2 + P4_SC[5]) * ctx->NzInterior
			+ (P4_SS[0] + P4_SS[1] + P4_SS[2] + P4_SS[3] + P4_SS[4] + 6));
		// All rows are 5 * dim + IDX(i, j).
		for (k = 0; k < P4_SS[5]; ++k)
		{
	...
	else
	{
		...
		for (i = ctx->ghost; i < ctx->NrInterior + ctx->ghost; i++)
		{
			...
			offset[1] = 1 + 2 * (P2_CC[0]) * ctx->NrInterior * ctx->NzInterior + 2 * P2_CC[1] * ctx->NzInterior * (i - ctx->ghost);
			for (j = ctx->ghost; j < ctx->NzInterior + ctx->ghost; j++)
			{
				// Row indices are all row dim + IDX(i, j).
			...
			offset[2] = 1 + 2 * (P2_CC[0] + P2_CC[1]) * ctx->NrInterior * ctx->NzInterior + 2 * P2_CC[2] * ctx->NzInterior * (i - ctx->ghost); 
			for (j = ctx->ghost; j < ctx->NzInterior + ctx->ghost; j++)
			{
				// Row indices are all row 2 * dim + IDX(i, j).
			...
			offset[3] = 1 + 2 * (P2_CC[0] + P2_CC[1] + P2_CC[2]) * ctx->NrInterior * ctx->NzInterior + 2 * P2_CC[3] * ctx->NzInterior * (i - ctx->ghost); 
			for (j = ctx->ghost; j < ctx->NzInterior + ctx->ghost; j++)
			{
				// Row indices are all row 3 * dim + IDX(i, j).
			...
			offset[4] = 1 + 2 * (P2_CC[0] + P2_CC[1] + P2_CC[2] + P2_CC[3]) * ctx->NrInterior * ctx->NzInterior + 2 * (P2_CC[4] * ctx->NzInterior + 2) * (i - ctx->ghost);
			for (j = ctx->ghost; j < ctx->NzInterior + ctx->ghost; j++)
			{
				// Row indices are all row 4 * dim + IDX(i, j).
				diff[offset[4] +  0] = 4 * ctx->dim + IDX(i, j);
		...
		// Boundary points.
		offset[4] = 1 + 2 * (P2_CC[0] + P2_CC[1] + P2_CC[2] + P2_CC[3] + P2_CC[4]) * ctx->NrInterior * ctx->NzInterior + 4 * ctx->NrInterior;
		...
		for (i = ctx->ghost; i < ctx->NrInterior + ctx->ghost; i++)
		{
			...
			offset[5] = 1 + 2 * ((P2_CC[0] + P2_CC[1] + P2_CC[2] + P2_CC[3] + P2_CC[4]) * ctx->NrInterior * ctx->NzInterior + 2 * (ctx->NrInterior + ctx->NzInterior + 1)) + 2 * P2_CC[5] * ctx->NzInterior * (i - ctx->ghost);
			for (j = ctx->ghost; j < ctx->NzInterior + ctx->ghost; j++)
			{
				// Row indices are all row 5 * dim + IDX(i, j).
