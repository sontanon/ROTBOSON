	...
	const double w, const double m, const MKL_INT l)
{
	...
	double *log_alpha = u;
	double *alpha = (double *)SAFE_MALLOC(dim * sizeof(double));
	double *Dr_alpha = (double *)SAFE_MALLOC(dim * sizeof(double));
	double *Dz_alpha = (double *)SAFE_MALLOC(dim * sizeof(double));
	double *Drr_alpha = (double *)SAFE_MALLOC(dim * sizeof(double));
	double *Dzz_alpha = (double *)SAFE_MALLOC(dim * sizeof(double));
	double *alpha00 = (double *)SAFE_MALLOC(NzTotal * sizeof(double));
	double *alpha01 = (double *)SAFE_MALLOC(NzTotal * sizeof(double));
	double *alpha02 = (double *)SAFE_MALLOC(NzTotal * sizeof(double));
	double *alpha03 = (double *)SAFE_MALLOC(NzTotal * sizeof(double));
	double *alpha20 = (double *)SAFE_MALLOC(NzTotal * sizeof(double));
	...
	double *beta00 = (double *)SAFE_MALLOC(NzTotal * sizeof(double));
	double *beta01 = (double *)SAFE_MALLOC(NzTotal * sizeof(double));

	double *log_h = u + 2 * dim;
	double *H = (double *)SAFE_MALLOC(dim * sizeof(double));
	double *Dr_H = (double *)SAFE_MALLOC(dim * sizeof(double));
	double *Dz_H = (double *)SAFE_MALLOC(dim * sizeof(double));
	double *Drr_H = (double *)SAFE_MALLOC(dim * sizeof(double));
	double *Dzz_H = (double *)SAFE_MALLOC(dim * sizeof(double));
	double *H00 = (double *)SAFE_MALLOC(NzTotal * sizeof(double));
	double *H01 = (double *)SAFE_MALLOC(NzTotal * sizeof(double));
	double *H02 = (double *)SAFE_MALLOC(NzTotal * sizeof(double));
	double *H03 = (double *)SAFE_MALLOC(NzTotal * sizeof(double));
	double *H20 = (double *)SAFE_MALLOC(NzTotal * sizeof(double));
	double *H21 = (double *)SAFE_MALLOC(NzTotal * sizeof(double));
	double *H22 = (double *)SAFE_MALLOC(NzTotal * sizeof(double));
	double *H40 = (double *)SAFE_MALLOC(NzTotal * sizeof(double));

	double *log_a = u + 3 * dim;
	double *A = (double *)SAFE_MALLOC(dim * sizeof(double));

	double *psi = u + 4 * dim;
	double *Dr_psi = Dr_u + 4 * dim;
	double *Drr_psi = Drr_u + 4 * dim;
	double *psi00 = (double *)SAFE_MALLOC(NzTotal * sizeof(double));
	double *psi01 = (double *)SAFE_MALLOC(NzTotal * sizeof(double));
	double *psi02 = (double *)SAFE_MALLOC(NzTotal * sizeof(double));

	double *lambda00 = (double *)SAFE_MALLOC(NzTotal * sizeof(double));
	double *lambda20 = (double *)SAFE_MALLOC(NzTotal * sizeof(double));
